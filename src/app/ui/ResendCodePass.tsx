...
export function ResendCodePass({ t, lang }: { t: any; lang: string }) {
  const [state, action] = useActionState(ResendCodePassAction, undefined);
      ...
      >
        <h1 className="font-bold text-xl md:text-2xl">
          ...
          {lang === "en"
            ...
            : "إعادة إرسال كود إعادة تعيين كلمة السر"}{" "}
          :
        </h1>
