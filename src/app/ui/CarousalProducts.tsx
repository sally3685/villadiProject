              ...
              {(items.length < (isMobile ? 3 : 5) ? items : extendedItems)?.map(
                (product: any, index: any) => (
                  <div
                    ...
                    key={index}
                    className={`w-[300px] h-[300px] sm:w-[350px] sm:h-[300px] bg-white/50 flex justify-center items-center relative rounded-2xl flex-col gap-4 before:absolute before:content-[''] before:w-full before:h-full before:bg-white before:top-0 before:block before:mask-[url(/pattern2.svg)] before:mask-center before:mask-[350%,350%] ${
             ...
             after:absolute after:content-[''] after:w-1/3 after:h-1/2 after:bg-[#ffffff66] after:bottom-[-10px] after:blur-2xl after:right-[15%] after:opacity-50 z-[0] "
                    ...
                    <h2
                      style={{
                        ...
                        color: getContrastColor(product.p_color),
                      }}
